...
---
Update generated/situation.md with status, blockers, and next actions.
```
...
Outputs generated by Assistant, automations, or AI models must be reviewed before being used for operational, legal, financial, security, or production decisions.
