...
Devsync is a filesystem-first product for managing a team or solo developer's operational memory, documentation, artifacts, plan items, activity logs, AI Assistant, and automations.
...
- `generated/`: outputs generated by automations/Assistant.
...
- right rail for logs, artifacts, plan items, Assistant, automations;
