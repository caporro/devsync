...
Devsync is a filesystem-first product for managing a team or solo developer's operational memory, documentation, artifacts, tasks, activity logs, AI Assistant, and automations.
...
- right rail for logs, artifacts, tasks, Assistant, automations;
...
- "What changed since last sync" for artifacts/tasks/logs.
